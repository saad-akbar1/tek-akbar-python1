...
print("Hi, my name is " + first_name + " " + last_name + " and I am", my_age, "years old.")
print("Hi, my name is %s %s and I am %s years old." % (first_name, last_name, my_age))
print("Hi, my name is " + " ".join([first_name, last_name])+ " and I am " + " ".join(["26", "years old."]))
...
drinks = ["water","coffee","tea","soda","juice"]
kitchen = ["plate","dish","cup","bowl","fork"]
clothes = ["hat","shirt","pants","socks","shoes"]
furniture = ["table","chair","sofa","bed","drawer"]
food = ["burger","pizza","pasta","noodles","kebab"]

fast_food = {"mcdonalds":"burger","starbucks":"coffee"}
honda = {"accord":"car","odyssy":"van"}
meals = {"breakfast":1,"lunch":2,"dinner":3}
sun = {"sunrise":"dawn","sunset":"dusk"}
cleaning = {"dishwasher":"plates","washing_mashine":"clothes"}
